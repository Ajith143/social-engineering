...
<div class="cover--header pt--80 text-center" data-bg-img="img/cover-header-img/bg-01.jpg" data-overlay="0.6" data-overlay-color="white">
            <div class="container">
                ...
                <div class="cover--user-name">
                    <h2 class="h3 fw--600">Samuel C. Azevedo</h2>
                </div>
                        ...
                        <div class="main--content-inner drop--shadow">
                            ...
                            <div class="content--nav pb--30">
                                <ul class="nav ff--primary fs--14 fw--500 bg-lighter">
                                    <li class="active"><a href="activity1.php">Recent posts</a></li>
                                ...
                                <ul class="activity--items nav">
                                        ...
                                        <div class="activity--item">
                                            ...
                                            <div class="activity--info fs--14">
                                                <div class="activity--header">
                                                    <p><a href="#">Programming In C&C++</a></p>
                                                </div>
												...
												<div class="activity--header">
                                                    <p><a href="forum_discussion.php">Any Suggestions</a></p>
                                                </div>                                                    
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <li>
                                        ...
                                        <div class="activity--item">
                                            ...
                                            <div class="activity--info fs--14">
                                                <div class="activity--header">
                                                    <p><a href="#">The Complete Reference In Java</a></p>
                                                </div>
                                                <div class="activity--content">
                                        ...
                                        <div class="activity--item">
                                            <div class="activity--avatar">
                                                <a href="member-activity-personal.html">
                                                     <img src="img/cart-img/php& mysql.jpg" alt="">                                               </a>                                            </div>

                                            <div class="activity--info fs--14">
                                                <div class="activity--header">
                                                    <p><a href="#">Beginning PHP and MYSQL</a></p>
                                                </div>
                                                        ...
                                                        <li>
                                                            <div class="acomment--item clearfix">
                                                                <div class="acomment--avatar">
                                                                    <a href="member-activity-personal.html">
                                                                        <img src="img/cart-img/phython.jpeg" alt="">                                                                    </a>                                                               
																    </div>
